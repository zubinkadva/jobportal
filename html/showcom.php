...
$selquery="select * from com_register";
...
while($row = mysql_fetch_array($result))
  ...
  echo "<td>" . $row['comeid'] . "</td>";
  echo "<td>" . $row['compass'] . "</td>";
  echo "<td>" . $row['comname'] . "</td>";
  echo "<td>" . $row['comadd'] . "</td>";
  echo "<td>" . $row['comweb'] . "</td>";
  echo "<td>" . $row['comper'] . "</td>";
  echo "<td>" . $row['commono'] . "</td>";
  
  echo "</tr>";
  }
echo "</table>";
echo"<form name='delfrm' method='post' action='delcom.php'>";
